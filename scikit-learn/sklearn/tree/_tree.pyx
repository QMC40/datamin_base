...
cdef class TreeBuilder:
    ...
    cpdef build(self, Tree tree, object X, cnp.ndarray y, cnp.ndarray s, double alpha, double initial_split_factor,
...
cdef class DepthFirstTreeBuilder(TreeBuilder):
    ...
    cpdef build(self, Tree tree, object X, cnp.ndarray y, cnp.ndarray s, double alpha, double initial_split_factor,
        ...
        splitter.init(X, y, s, alpha, initial_split_factor, sample_weight_ptr)
...
cdef class BestFirstTreeBuilder(TreeBuilder):
    ...
    cdef inline int _add_split_node(self, Splitter splitter, Tree tree,
                                    ...
                                    SIZE_t depth,
                                    FrontierRecord* res) nogil except *:
...
cdef class Tree:
    ...
    def __cinit__(self, int n_features, cnp.ndarray n_classes, int n_outputs, cnp.ndarray cat_pos, cnp.ndarray cat_maxval):
        """Constructor."""
        cdef SIZE_t dummy = 0
    ...
    cdef int _resize(self, SIZE_t capacity) nogil except *:
    ...
    cdef int _resize_c(self, SIZE_t capacity=SIZE_MAX) nogil except *:
        """Guts of _resize
