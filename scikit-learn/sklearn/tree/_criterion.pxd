...
cdef class Criterion:
    ...
    cdef const DOUBLE_t[:, :] s        # Values of s
    ...
    cdef SIZE_t n_sensitive              # Number of sensitive attributes
    ...
    const DTYPE_t[:, :] X, const DOUBLE_t[:, ::1] y, const DOUBLE_t[:, :] s, double alpha,
...
cdef class ClassificationCriterion(Criterion):
    ...
    cdef SIZE_t[::1] n_classes_sens
    cdef SIZE_t max_n_classes
    cdef SIZE_t max_n_classes_sens
    ...
    # Count labels for each sens attribute
    cdef double[:, :, ::1] sum_total_feat_sens 
    cdef double[:, :, ::1] sum_left_feat_sens  
    cdef double[:, :, ::1] sum_right_feat_sens 
