...
from .datasets import OUTPUT_DATA_ARRAY_TYPE, Dataset
from .model import Model, ModelOutputType
...
class SklearnModel(Model):
    ...
    def score(self, test_data: Dataset, **kwargs):
        ...
        return self.model.score(
            test_data.get_samples(), test_data.get_labels(), **kwargs
        )
...
class SklearnRegressor(SklearnModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            model,
            ModelOutputType.REGRESSOR_SCALAR,
            black_box_access,
            unlimited_queries,
            **kwargs
        )
